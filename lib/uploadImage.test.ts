...
// tests port lib/storageRead.test.ts's mocking pattern verbatim, swapping
// the mocked module for @/lib/supabase/client, so the two copies can't
...
const { mintSignedUrl, mintSignedUrls } = await import("@/lib/uploadImage");
